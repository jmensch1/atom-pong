...
export default function PongGame(rootElement, listenForKeys) {
  ...
  var PongDOM = CreatePongDOM(rootElement, WIDTH, HEIGHT)
  ...
  function prepForPoint(user, comp, ball, status, points) {
    ...
    PongDOM.resetCanvas();
    PongDOM.drawPoints(points);
    PongDOM.drawPaddle(user);
    PongDOM.drawPaddle(comp);
  }
